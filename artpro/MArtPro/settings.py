...
import djcelery
djcelery.setup_loader()#加载djangocelery应用
# 配置消息中间件
BROKER_URL = "redis://127.0.0.1:6379/5"
CELERY_IMPORTS = ('art.tasks')#初始导入celery 任务位置
CELERY_TIMEZONE = "Asia/Shanghai" #时区
# 配置任务定时队列存储的位置
CELERYBETA_SCHEDULER = "djcelery.schedulers.DatabaseScheduler"

# 配置定时任务
CELERYBETA_SCHEDULER = {
    u"定时发邮件":{
        'task':'',
        'schedule':"",
